...
use App\Http\Controllers\Therapist\CommissionController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('management')->name('management.')->middleware('role:management')->group(function () {
        ...
        Route::patch('commissions/{commission}/status', [TherapistCommissionController::class, 'updateStatus'])
            ->name('commissions.update-status');
