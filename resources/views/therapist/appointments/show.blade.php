    ...
    <div class="mx-auto max-w-3xl">
        ...
        <x-card>
            ...
            <dl class="mt-7 grid gap-x-8 gap-y-6 sm:grid-cols-2">
                <div>
                    <dt class="spa-detail-label">Guest</dt>
                ...
                @if ($appointment->notes)<div class="sm:col-span-2"><dt class="spa-detail-label">Appointment notes</dt><dd class="mt-1.5 whitespace-pre-line rounded-xl bg-cream-100 p-4 leading-6 text-cocoa-800">{{ $appointment->notes }}</dd></div>@endif
            </dl>
        </x-card>
    </div>
@endsection
