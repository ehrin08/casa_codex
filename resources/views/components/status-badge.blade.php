...
@php
    ...
    $classes = match ($normalized) {
        'active', 'confirmed', 'completed', 'paid', 'read', 'positive' => 'bg-sage-100 text-sage-800 ring-sage-600/20',
        'pending', 'pending_confirmation', 'neutral' => 'bg-amber-100 text-amber-900 ring-amber-600/20',
        'cancelled', 'canceled', 'inactive', 'no_show', 'void', 'negative' => 'bg-stone-200 text-stone-700 ring-stone-500/20',
