...
@section('content')
    @php
        $sections = [
            ...
            ['title' => 'Commissions', 'description' => 'Review therapist earnings and settle pending commission records.', 'route' => 'management.commissions.index', 'label' => 'Manage commissions'],
