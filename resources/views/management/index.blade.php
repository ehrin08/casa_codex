...
@section('content')
    <div class="mb-8 rounded-2xl bg-cocoa-800 p-6 text-cream-50 sm:p-8">
    ...
    <div class="mb-8">
        ...
        <div class="grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
            <div class="spa-panel p-6">
                <p class="text-xs font-bold uppercase tracking-[0.14em] text-sage-700">Today&rsquo;s Appointments</p>
            ...
            <div class="spa-panel p-6">
                <p class="text-xs font-bold uppercase tracking-[0.14em] text-sage-700">Today&rsquo;s Paid Revenue</p>
                <p class="mt-2 text-3xl font-semibold text-cocoa-950">PHP {{ number_format($todayPaidRevenue, 2) }}</p>
            ...
            <div class="spa-panel p-6">
                ...
                <a href="{{ route('management.transactions.index') }}" class="mt-4 block text-sm font-medium text-sage-700 hover:text-sage-900">Open transactions &rarr;</a>
            </div>
    ...
    <div class="mb-8">
        <h3 class="mb-4 text-xs font-bold uppercase tracking-[0.18em] text-cocoa-500">Daily Actions</h3>
        <div class="flex flex-wrap gap-4">
            <x-button :href="route('management.walk-ins.create')">Book Walk-in</x-button>
            <x-button :href="route('management.appointments.index')" variant="secondary">Today&rsquo;s Appointments</x-button>
            <x-button :href="route('management.transactions.index')" variant="secondary">Record Payment</x-button>
            <x-button :href="route('management.reports.index')" variant="secondary">View Reports</x-button>
        </div>
    </div>
    ...
    <div class="grid gap-8 lg:grid-cols-2">
        ...
        <div>
            ...
            <div class="spa-panel divide-y divide-cream-200 overflow-hidden">
                ...
                @empty
                    <x-empty-state title="No urgent items" description="Everything is running smoothly, and no appointments, payments, or reviews need attention right now." class="border-0" />
                @endforelse
            </div>
        </div>
